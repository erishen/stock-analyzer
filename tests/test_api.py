...
def temp_db():
    ...
    test_data = [
        ("000001", "2024-01-01", 10.0, 10.5, 10.8, 9.9, 1000000, 10500000, 5.0, 0.1, 45.0, 10.2, 10.0),
        ("000001", "2024-01-02", 10.5, 10.3, 10.6, 10.2, 1200000, 12360000, -2.0, 0.08, 50.0, 10.3, 10.1),
        ("000002", "2024-01-01", 20.0, 20.5, 20.8, 19.9, 2000000, 41000000, 2.5, 0.05, 55.0, 20.2, 20.0),
    ]
    conn.executemany(
